...
public class BlockDiagramCodeAdapterTrafo extends SynchronizationHelper{

   public BlockDiagramCodeAdapterTrafo()
   {
	...
	public static void main(String[] args) throws IOException {
        ...
        BlockDiagramCodeAdapterTrafo helper = new BlockDiagramCodeAdapterTrafo();
		helper.performForward("instances/fwd.src.xmi");
		
		// Backward Transformation
		helper = new BlockDiagramCodeAdapterTrafo();
