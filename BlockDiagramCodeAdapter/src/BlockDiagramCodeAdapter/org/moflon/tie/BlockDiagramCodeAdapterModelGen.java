...
public class BlockDiagramCodeAdapterModelGen extends SynchronizationHelper{

   public BlockDiagramCodeAdapterModelGen()
   {
	...
	public static void main(String[] args) throws IOException {
		...
		ModelGenerator gen = new ModelGenerator(BlockDiagramCodeAdapterPackage.eINSTANCE, controller);
		gen.generate();
	}
}