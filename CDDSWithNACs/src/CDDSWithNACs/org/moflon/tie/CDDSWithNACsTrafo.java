...
public class CDDSWithNACsTrafo extends SynchronizationHelper{

   public CDDSWithNACsTrafo()
   {
	...
	public static void main(String[] args) throws IOException {
        ...
        CDDSWithNACsTrafo helper = new CDDSWithNACsTrafo();
		helper.performForward("instances/fwd.src.xmi");
		
		// Backward Transformation
		helper = new CDDSWithNACsTrafo();
