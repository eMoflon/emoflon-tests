...
public class CDDSWithNACsModelGen extends SynchronizationHelper{

   public CDDSWithNACsModelGen()
   {
	...
	public static void main(String[] args) throws IOException {
		...
		ModelGenerator gen = new ModelGenerator(CDDSWithNACsPackage.eINSTANCE, controller);
		gen.generate();
	}
}