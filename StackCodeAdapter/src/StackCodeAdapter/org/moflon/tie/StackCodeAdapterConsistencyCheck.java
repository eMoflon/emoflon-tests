...
public class StackCodeAdapterConsistencyCheck extends SynchronizationHelper{

   public StackCodeAdapterConsistencyCheck()
   {
	...
	public static void main(String[] args) throws IOException {
        ...
        StackCodeAdapterConsistencyCheck helper = new StackCodeAdapterConsistencyCheck();
