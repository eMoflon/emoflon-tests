...
public class BlockCodeAdapterTrafo extends SynchronizationHelper{

   public BlockCodeAdapterTrafo()
   {
	...
	public static void main(String[] args) throws IOException {
        ...
        BlockCodeAdapterTrafo helper = new BlockCodeAdapterTrafo();
		helper.performForward("instances/fwd.src.xmi");
		
		// Backward Transformation
		helper = new BlockCodeAdapterTrafo();
