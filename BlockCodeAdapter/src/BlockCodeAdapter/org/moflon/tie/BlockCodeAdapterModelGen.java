...
public class BlockCodeAdapterModelGen extends SynchronizationHelper{

   public BlockCodeAdapterModelGen()
   {
	...
	public static void main(String[] args) throws IOException {
		...
		ModelGenerator gen = new ModelGenerator(BlockCodeAdapterPackage.eINSTANCE, controller);
		gen.generate();
	}
}