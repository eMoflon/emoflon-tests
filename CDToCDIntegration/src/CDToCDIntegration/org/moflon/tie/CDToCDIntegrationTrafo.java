...
public class CDToCDIntegrationTrafo extends SynchronizationHelper{

   public CDToCDIntegrationTrafo()
   {
	...
	public static void main(String[] args) throws IOException {
        ...
        CDToCDIntegrationTrafo helper = new CDToCDIntegrationTrafo();
		helper.performForward("instances/fwd.src.xmi");
		
		// Backward Transformation
		helper = new CDToCDIntegrationTrafo();
