...
public class CDToCDIntegrationModelGen extends SynchronizationHelper{

   public CDToCDIntegrationModelGen()
   {
	...
	public static void main(String[] args) throws IOException {
		...
		ModelGenerator gen = new ModelGenerator(CDToCDIntegrationPackage.eINSTANCE, controller);
		gen.generate();
	}
}