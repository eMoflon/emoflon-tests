...
public class FamiliesToPersonsRefinementFlatTrafo extends SynchronizationHelper{

   public FamiliesToPersonsRefinementFlatTrafo()
   {
	...
	public static void main(String[] args) throws IOException {
        ...
        FamiliesToPersonsRefinementFlatTrafo helper = new FamiliesToPersonsRefinementFlatTrafo();
		helper.performForward("instances/fwd.src.xmi");
		
		// Backward Transformation
		helper = new FamiliesToPersonsRefinementFlatTrafo();
