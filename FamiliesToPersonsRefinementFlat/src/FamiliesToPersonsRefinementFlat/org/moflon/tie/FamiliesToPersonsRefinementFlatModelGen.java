...
public class FamiliesToPersonsRefinementFlatModelGen extends SynchronizationHelper{

   public FamiliesToPersonsRefinementFlatModelGen()
   {
	...
	public static void main(String[] args) throws IOException {
		...
		ModelGenerator gen = new ModelGenerator(FamiliesToPersonsRefinementFlatPackage.eINSTANCE, controller);
		gen.generate();
	}
}