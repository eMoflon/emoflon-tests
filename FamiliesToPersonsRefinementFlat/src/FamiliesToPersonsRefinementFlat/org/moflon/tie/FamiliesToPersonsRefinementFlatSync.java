...
public class FamiliesToPersonsRefinementFlatSync extends SynchronizationHelper{

   public FamiliesToPersonsRefinementFlatSync()
   {
	...
	public static void main(String[] args) throws IOException {
		...
		FamiliesToPersonsRefinementFlatSync helper = new FamiliesToPersonsRefinementFlatSync();
