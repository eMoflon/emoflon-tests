 ...
 * @generated
 */
public class LearningBoxLanguageSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	public LearningBoxLanguageSwitch() {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case LearningBoxLanguagePackage.FAST_CARD: {
			FastCard fastCard = (FastCard) theEObject;
			T result = caseFastCard(fastCard);
			if (result == null)
				result = caseCard(fastCard);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Fast Card</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Fast Card</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseFastCard(FastCard object) {
		return null;
	}
