...
public class ClassDiagramToRDBMSIntegrationSync extends SynchronizationHelper{

   public ClassDiagramToRDBMSIntegrationSync()
   {
	...
	public static void main(String[] args) throws IOException {
		...
		ClassDiagramToRDBMSIntegrationSync helper = new ClassDiagramToRDBMSIntegrationSync();
