...
public class ClassDiagramToRDBMSIntegrationConsistencyCheck extends SynchronizationHelper{

   public ClassDiagramToRDBMSIntegrationConsistencyCheck()
   {
	...
	public static void main(String[] args) throws IOException {
        ...
        ClassDiagramToRDBMSIntegrationConsistencyCheck helper = new ClassDiagramToRDBMSIntegrationConsistencyCheck();
