...
public class ClassDiagramToRDBMSIntegrationTrafo extends SynchronizationHelper{

   public ClassDiagramToRDBMSIntegrationTrafo()
   {
	...
	public static void main(String[] args) throws IOException {
        ...
        ClassDiagramToRDBMSIntegrationTrafo helper = new ClassDiagramToRDBMSIntegrationTrafo();
		helper.performForward("instances/fwd.src.xmi");
		
		// Backward Transformation
		helper = new ClassDiagramToRDBMSIntegrationTrafo();
