// $ANTLR 3.5.2 D:\\modelgeneratorTestsuiteWorkspace\\DictionaryCodeAdapter\\src\\org\\moflon\\moca\\dictionary\\unparser\\DictionaryTreeGrammar.g 2015-01-02 12:15:51
...
public class DictionaryTreeGrammar extends TreeParser {
	...
	@Override public String getGrammarFileName() { return "D:\\modelgeneratorTestsuiteWorkspace\\DictionaryCodeAdapter\\src\\org\\moflon\\moca\\dictionary\\unparser\\DictionaryTreeGrammar.g"; }
	...
	// $ANTLR start "main"
	// D:\\modelgeneratorTestsuiteWorkspace\\DictionaryCodeAdapter\\src\\org\\moflon\\moca\\dictionary\\unparser\\DictionaryTreeGrammar.g:34:1: main : ^( 'DICTIONARY' name= STRING (author= STRING )? (entries+= entry )+ ) -> dictionary(name=$nameauthor=$authorentires=$entries);
	public final DictionaryTreeGrammar.main_return main() throws RecognitionException {
		...
		try {
			// D:\\modelgeneratorTestsuiteWorkspace\\DictionaryCodeAdapter\\src\\org\\moflon\\moca\\dictionary\\unparser\\DictionaryTreeGrammar.g:34:5: ( ^( 'DICTIONARY' name= STRING (author= STRING )? (entries+= entry )+ ) -> dictionary(name=$nameauthor=$authorentires=$entries))
			// D:\\modelgeneratorTestsuiteWorkspace\\DictionaryCodeAdapter\\src\\org\\moflon\\moca\\dictionary\\unparser\\DictionaryTreeGrammar.g:34:7: ^( 'DICTIONARY' name= STRING (author= STRING )? (entries+= entry )+ )
			{
			match(input,7,FOLLOW_7_in_main86); 
			match(input, Token.DOWN, null); 
			name=(CommonTree)match(input,STRING,FOLLOW_STRING_in_main90); 
			// D:\\modelgeneratorTestsuiteWorkspace\\DictionaryCodeAdapter\\src\\org\\moflon\\moca\\dictionary\\unparser\\DictionaryTreeGrammar.g:34:40: (author= STRING )?
			int alt1=2;
			...
			// D:\\modelgeneratorTestsuiteWorkspace\\DictionaryCodeAdapter\\src\\org\\moflon\\moca\\dictionary\\unparser\\DictionaryTreeGrammar.g:34:56: (entries+= entry )+
			int cnt2=0;
			loop2:
			while (true) {
				int alt2=2;
	...
	// $ANTLR start "entry"
	// D:\\modelgeneratorTestsuiteWorkspace\\DictionaryCodeAdapter\\src\\org\\moflon\\moca\\dictionary\\unparser\\DictionaryTreeGrammar.g:37:1: entry : ^( 'ENTRY' entryLabel= STRING level= STRING ) -> entry(entry=$entryLabellevel=$level);
	public final DictionaryTreeGrammar.entry_return entry() throws RecognitionException {
		...
		try {
			// D:\\modelgeneratorTestsuiteWorkspace\\DictionaryCodeAdapter\\src\\org\\moflon\\moca\\dictionary\\unparser\\DictionaryTreeGrammar.g:37:6: ( ^( 'ENTRY' entryLabel= STRING level= STRING ) -> entry(entry=$entryLabellevel=$level))
			// D:\\modelgeneratorTestsuiteWorkspace\\DictionaryCodeAdapter\\src\\org\\moflon\\moca\\dictionary\\unparser\\DictionaryTreeGrammar.g:37:8: ^( 'ENTRY' entryLabel= STRING level= STRING )
			{
