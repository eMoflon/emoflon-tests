...
public class BxSurveyClassDiagramToRDBMSIntegrationSync extends SynchronizationHelper{

   public BxSurveyClassDiagramToRDBMSIntegrationSync()
   {
	...
	public static void main(String[] args) throws IOException {
		...
		BxSurveyClassDiagramToRDBMSIntegrationSync helper = new BxSurveyClassDiagramToRDBMSIntegrationSync();
