...
public class BxSurveyClassDiagramToRDBMSIntegrationModelGen extends SynchronizationHelper{

   public BxSurveyClassDiagramToRDBMSIntegrationModelGen()
   {
	...
	public static void main(String[] args) throws IOException {
		...
		ModelGenerator gen = new ModelGenerator(BxSurveyClassDiagramToRDBMSIntegrationPackage.eINSTANCE, controller);
		gen.generate();
	}
}