...
public class BxSurveyClassDiagramToRDBMSIntegrationTrafo extends SynchronizationHelper{

   public BxSurveyClassDiagramToRDBMSIntegrationTrafo()
   {
	...
	public static void main(String[] args) throws IOException {
        ...
        BxSurveyClassDiagramToRDBMSIntegrationTrafo helper = new BxSurveyClassDiagramToRDBMSIntegrationTrafo();
		helper.performForward("instances/fwd.src.xmi");
		
		// Backward Transformation
		helper = new BxSurveyClassDiagramToRDBMSIntegrationTrafo();
