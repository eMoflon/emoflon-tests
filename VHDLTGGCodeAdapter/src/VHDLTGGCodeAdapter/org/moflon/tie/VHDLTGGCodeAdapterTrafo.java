...
public class VHDLTGGCodeAdapterTrafo extends SynchronizationHelper{

   public VHDLTGGCodeAdapterTrafo()
   {
	...
	public static void main(String[] args) throws IOException {
        ...
        VHDLTGGCodeAdapterTrafo helper = new VHDLTGGCodeAdapterTrafo();
		helper.performForward("instances/fwd.src.xmi");
		
		// Backward Transformation
		helper = new VHDLTGGCodeAdapterTrafo();
