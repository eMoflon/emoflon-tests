...
public class VHDLTGGCodeAdapterSync extends SynchronizationHelper{

   public VHDLTGGCodeAdapterSync()
   {
	...
	public static void main(String[] args) throws IOException {
		...
		VHDLTGGCodeAdapterSync helper = new VHDLTGGCodeAdapterSync();
