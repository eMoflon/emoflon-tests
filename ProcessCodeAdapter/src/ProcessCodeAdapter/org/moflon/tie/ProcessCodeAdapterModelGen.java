...
public class ProcessCodeAdapterModelGen extends SynchronizationHelper{

   public ProcessCodeAdapterModelGen()
   {
	...
	public static void main(String[] args) throws IOException {
		...
		ModelGenerator gen = new ModelGenerator(ProcessCodeAdapterPackage.eINSTANCE, controller);
		gen.generate();
	}
}