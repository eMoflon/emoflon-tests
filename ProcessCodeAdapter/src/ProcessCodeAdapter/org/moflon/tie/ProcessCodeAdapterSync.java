...
public class ProcessCodeAdapterSync extends SynchronizationHelper{

   public ProcessCodeAdapterSync()
   {
	...
	public static void main(String[] args) throws IOException {
		...
		ProcessCodeAdapterSync helper = new ProcessCodeAdapterSync();
