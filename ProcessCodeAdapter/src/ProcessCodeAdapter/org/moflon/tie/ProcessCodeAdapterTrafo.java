...
public class ProcessCodeAdapterTrafo extends SynchronizationHelper{

   public ProcessCodeAdapterTrafo()
   {
	...
	public static void main(String[] args) throws IOException {
        ...
        ProcessCodeAdapterTrafo helper = new ProcessCodeAdapterTrafo();
		helper.performForward("instances/fwd.src.xmi");
		
		// Backward Transformation
		helper = new ProcessCodeAdapterTrafo();
