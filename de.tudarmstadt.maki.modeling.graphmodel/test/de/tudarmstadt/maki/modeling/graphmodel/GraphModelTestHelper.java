...
public class GraphModelTestHelper {
	private GraphModelTestHelper() {
	...
	public static void assertHasState(final Graph topology, final EdgeState state, final boolean checkSymmetry,
		...
		for (final String edgeId : edgeIds) {
			...
			GraphModelTestHelper.assertHasState(edge, state);
			if (checkSymmetry) {
				GraphModelTestHelper.assertHasState(edge.getReverseEdge(), state);
			}
		}
	}
	...
	public static void assertIsActive(final Edge edge) {
		GraphModelTestHelper.assertHasState(edge, EdgeState.ACTIVE);
	}
	...
	public static void assertIsInactive(final Edge edge) {
		GraphModelTestHelper.assertHasState(edge, EdgeState.INACTIVE);
	}
	...
	public static void assertIsUnclassified(final Edge edge) {
		GraphModelTestHelper.assertHasState(edge, EdgeState.UNCLASSIFIED);
	}
