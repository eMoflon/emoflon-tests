...
public class OOToDatabaseIntegrationSync extends SynchronizationHelper{

   public OOToDatabaseIntegrationSync()
   {
	...
	public static void main(String[] args) throws IOException {
		...
		OOToDatabaseIntegrationSync helper = new OOToDatabaseIntegrationSync();
