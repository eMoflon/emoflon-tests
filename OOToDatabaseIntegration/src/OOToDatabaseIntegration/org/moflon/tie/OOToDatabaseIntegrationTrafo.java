...
public class OOToDatabaseIntegrationTrafo extends SynchronizationHelper{

   public OOToDatabaseIntegrationTrafo()
   {
	...
	public static void main(String[] args) throws IOException {
        ...
        OOToDatabaseIntegrationTrafo helper = new OOToDatabaseIntegrationTrafo();
		helper.performForward("instances/fwd.src.xmi");
		
		// Backward Transformation
		helper = new OOToDatabaseIntegrationTrafo();
