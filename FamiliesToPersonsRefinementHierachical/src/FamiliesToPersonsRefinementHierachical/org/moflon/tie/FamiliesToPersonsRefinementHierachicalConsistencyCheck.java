...
public class FamiliesToPersonsRefinementHierachicalConsistencyCheck extends SynchronizationHelper{

   public FamiliesToPersonsRefinementHierachicalConsistencyCheck()
   {
	...
	public static void main(String[] args) throws IOException {
        ...
        FamiliesToPersonsRefinementHierachicalConsistencyCheck helper = new FamiliesToPersonsRefinementHierachicalConsistencyCheck();
