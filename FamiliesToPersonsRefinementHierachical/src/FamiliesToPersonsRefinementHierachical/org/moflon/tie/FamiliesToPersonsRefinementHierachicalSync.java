...
public class FamiliesToPersonsRefinementHierachicalSync extends SynchronizationHelper{

   public FamiliesToPersonsRefinementHierachicalSync()
   {
	...
	public static void main(String[] args) throws IOException {
		...
		FamiliesToPersonsRefinementHierachicalSync helper = new FamiliesToPersonsRefinementHierachicalSync();
