...
public class FamiliesToPersonsRefinementHierachicalTrafo extends SynchronizationHelper{

   public FamiliesToPersonsRefinementHierachicalTrafo()
   {
	...
	public static void main(String[] args) throws IOException {
        ...
        FamiliesToPersonsRefinementHierachicalTrafo helper = new FamiliesToPersonsRefinementHierachicalTrafo();
		helper.performForward("instances/fwd.src.xmi");
		
		// Backward Transformation
		helper = new FamiliesToPersonsRefinementHierachicalTrafo();
