...
public class RefinementTestTGGTrafo extends SynchronizationHelper{

   public RefinementTestTGGTrafo()
   {
	...
	public static void main(String[] args) throws IOException {
        ...
        RefinementTestTGGTrafo helper = new RefinementTestTGGTrafo();
		helper.performForward("instances/fwd.src.xmi");
		
		// Backward Transformation
		helper = new RefinementTestTGGTrafo();
