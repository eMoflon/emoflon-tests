package RefinementTestTGG.org.moflon.tie;
...
import RefinementTestTGG.RefinementTestTGGPackage;


public class RefinementTestTGGConsistencyCheck extends SynchronizationHelper{

   public RefinementTestTGGConsistencyCheck()
   {
      super(RefinementTestTGGPackage.eINSTANCE, ".");
   }
	public static void main(String[] args) throws IOException {
		// Set up logging
        BasicConfigurator.configure();
        
        RefinementTestTGGConsistencyCheck helper = new RefinementTestTGGConsistencyCheck();
