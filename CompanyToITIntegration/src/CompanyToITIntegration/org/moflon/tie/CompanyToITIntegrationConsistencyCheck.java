...
public class CompanyToITIntegrationConsistencyCheck extends SynchronizationHelper{

   public CompanyToITIntegrationConsistencyCheck()
   {
	...
	public static void main(String[] args) throws IOException {
        ...
        CompanyToITIntegrationConsistencyCheck helper = new CompanyToITIntegrationConsistencyCheck();
