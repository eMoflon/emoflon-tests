...
public class CompanyToITIntegrationSync extends SynchronizationHelper{

   public CompanyToITIntegrationSync()
   {
	...
	public static void main(String[] args) throws IOException {
		...
		CompanyToITIntegrationSync helper = new CompanyToITIntegrationSync();
