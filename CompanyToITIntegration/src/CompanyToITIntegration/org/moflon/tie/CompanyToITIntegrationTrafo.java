...
public class CompanyToITIntegrationTrafo extends SynchronizationHelper{

   public CompanyToITIntegrationTrafo()
   {
	...
	public static void main(String[] args) throws IOException {
        ...
        CompanyToITIntegrationTrafo helper = new CompanyToITIntegrationTrafo();
		helper.performForward("instances/fwd.src.xmi");
		
		// Backward Transformation
		helper = new CompanyToITIntegrationTrafo();
