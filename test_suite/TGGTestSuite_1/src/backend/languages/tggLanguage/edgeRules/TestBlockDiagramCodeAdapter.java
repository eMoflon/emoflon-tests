...
import BlockDiagram_EdgeRules.BlockDiagram_EdgeRulesPackage;
import MocaTree.MocaTreePackage;

public class TestBlockDiagramCodeAdapter extends IntegratorTest {

	public TestBlockDiagramCodeAdapter() {
		super(BlockDiagram_EdgeRulesPackage.eINSTANCE,
				BlockDiagramCodeAdapter_EdgeRulesPackage.eINSTANCE,
