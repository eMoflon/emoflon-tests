...
public class FamiliesToPersonsCodeAdapterSync extends SynchronizationHelper {

	public FamiliesToPersonsCodeAdapterSync() throws IOException {
		// Register packages
	...
	public static void main(String[] args) throws IOException {
        ...
        FamiliesToPersonsCodeAdapterSync helper = new FamiliesToPersonsCodeAdapterSync();
		helper.syncForward("instances/fwd.corr.xmi");
		
		// Propagate changes made to target
		helper = new FamiliesToPersonsCodeAdapterSync();
