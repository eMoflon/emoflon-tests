...
public class StackCodeAdapterSync extends SynchronizationHelper {

	public StackCodeAdapterSync() throws IOException {
		// Register packages
	...
	public static void main(String[] args) throws IOException {
        ...
        StackCodeAdapterSync helper = new StackCodeAdapterSync();
		helper.syncForward("instances/fwd.corr.xmi");
		
		// Propagate changes made to target
		helper = new StackCodeAdapterSync();
