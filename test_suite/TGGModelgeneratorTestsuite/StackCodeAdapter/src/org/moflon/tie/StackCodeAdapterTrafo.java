...
public class StackCodeAdapterTrafo extends SynchronizationHelper {

	public StackCodeAdapterTrafo() throws IOException {
		// Register packages
	...
	public static void main(String[] args) throws IOException {
        ...
        StackCodeAdapterTrafo helper = new StackCodeAdapterTrafo();
		helper.performForward("instances/fwd.src.xmi");
		
		// Backward Transformation
		helper = new StackCodeAdapterTrafo();
