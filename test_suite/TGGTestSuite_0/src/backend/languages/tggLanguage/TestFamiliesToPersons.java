...
public class TestFamiliesToPersons extends IntegratorTest
{

   public TestFamiliesToPersons()
   {
      super(FamiliesPackage.eINSTANCE, FamiliesToPersonsCodeAdapterPackage.eINSTANCE, PersonsPackage.eINSTANCE);
   }
