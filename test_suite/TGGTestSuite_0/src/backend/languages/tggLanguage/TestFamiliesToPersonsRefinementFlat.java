...
public class TestFamiliesToPersonsRefinementFlat extends IntegratorTest
{

   public TestFamiliesToPersonsRefinementFlat()
   {
      super(FamiliesPackage.eINSTANCE, FamiliesToPersonsRefinementFlatPackage.eINSTANCE, PersonsPackage.eINSTANCE);
   }
